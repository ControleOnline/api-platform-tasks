---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-tasks, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-tasks`.
...
- Checkout local: `api-community/modules/controleonline/tasks`
