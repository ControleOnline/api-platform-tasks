...
/**
 * Moves CRM opportunities (tasks of type "relationship") from pending to open
 * when their dueDate (data de retorno) has passed.
 */
class OverdueOpportunityMaintenanceService
{
    ...
    public function openPendingOpportunities(
        ...
        foreach ($tasks as $task) {
            ...
            if (method_exists($task, 'setAlterDate')) {
                $task->setAlterDate(\DateTime::createFromInterface($now));
            }
